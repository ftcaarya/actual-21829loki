...
@Autonomous(name = "Testing Vision please work")
public class EnhancedColorDetectionOpmode extends OpMode {
    ...
    public void start() {
        ...
        EnhancedColorDetectionProcessor.PropPositions recordedPropPosition = colourMassDetectionProcessor.getRecordedPropPosition();

        // now we can use recordedPropPosition to determine where the prop is! if we never saw a prop, your recorded position will be UNFOUND.
        // if it is UNFOUND, you can manually set it to any of the other positions to guess
        if (recordedPropPosition == EnhancedColorDetectionProcessor.PropPositions.UNFOUND) {
            recordedPropPosition = EnhancedColorDetectionProcessor.PropPositions.MIDDLE;
        }
