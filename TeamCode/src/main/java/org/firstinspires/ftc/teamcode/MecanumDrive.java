...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.5538469227118836; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 11.489117440028638;

        // feedforward parameters (in tick units)
        public double kS = 3.082763529959864;
        public double kV = 0.13420867419290045;
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration && error.position.x < 1 && error.heading.real < Math.toRadians(2) && error.position.y < 1 || t >= timeTrajectory.duration + 1) {
