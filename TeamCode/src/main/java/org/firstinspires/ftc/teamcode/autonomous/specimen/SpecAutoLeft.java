...
@Autonomous(name = "Spec side auto left")
public class SpecAutoLeft extends OpMode {
                ...
                new ParallelAction(
                        new SequentialAction(
                                drive.actionBuilder(new Pose2d(10, -63, Math.toRadians(270)))
                                        ...
                                        .splineToLinearHeading(new Pose2d(51, -45, Math.toRadians(290)), Math.toRadians(180))
                                        .stopAndAdd(
                                                new SequentialAction(
                                                        // spit it out
                                                )
                                        ...
                                        .splineToConstantHeading(new Vector2d(51, -63), Math.toRadians(270))
                                        .stopAndAdd(
                                                new SequentialAction(
                                                        // intake off the wall
                                                )
