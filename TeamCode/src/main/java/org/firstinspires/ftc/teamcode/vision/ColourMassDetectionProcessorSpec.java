...
public class ColourMassDetectionProcessorSpec implements VisionProcessor, CameraStreamSource {
     ...
     */
    public ColourMassDetectionProcessorSpec(DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
