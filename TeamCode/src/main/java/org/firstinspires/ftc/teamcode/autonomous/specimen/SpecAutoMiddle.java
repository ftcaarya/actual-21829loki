...
@Autonomous(name = "Spec auto side middle")
public class SpecAutoMiddle extends OpMode {
                ...
                new ParallelAction(
                        new SequentialAction(
                                drive.actionBuilder(new Pose2d(10, -63, Math.toRadians(270)))
                                        ...
                                        .setTangent(180)
                                        .splineToLinearHeading(new Pose2d(54, -45, Math.toRadians(290)), Math.toRadians(180))
                                        .stopAndAdd(
                                                new SequentialAction(
                                                        // spit it out
                                                )
                                        ...
                                        .splineToLinearHeading(new Pose2d(54, -63, Math.toRadians(270)), Math.toRadians(270))
                                        .stopAndAdd(
                                                new SequentialAction(
                                                        // intake off the wall
                                                )
                                        ...
                                        .splineToLinearHeading(new Pose2d(-20, -38, Math.toRadians(180)), Math.toRadians(180))
                                        .build()
                        ),
                        robot.updateVertPID(),
                        robot.updateExtPID()
